...
public class Roullate_Exit_Popup : MonoBehaviour
{
    public static Roullate_Exit_Popup Inst;
    ...
    public void BTN_YES()
    {
        ...
        SocketHandler.Inst.SendData(SocketEventManager.Inst.ROULETTE_CLOSE_GAME());
