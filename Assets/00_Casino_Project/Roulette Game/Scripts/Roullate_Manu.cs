...
public class Roullate_Manu : MonoBehaviour
{
    public static Roullate_Manu Inst;
    ...
    public void Music_ON_OFF()
    {
        ...
        if (PlayerPrefs.GetInt("music").Equals(1))
        {
            ...
            Roullate_SoundManager.Inst.BGAudio.mute = true;
        }
        else
        {
            IMG_MUSIC.sprite = Music_ON_Sprite;
            PlayerPrefs.SetInt("music", 1);
            Roullate_SoundManager.Inst.BGAudio.mute = false;
        }
    }
    ...
    public void Sound_ON_OFF()
    {
        ...
        if (PlayerPrefs.GetInt("sound").Equals(1))
        {
            ...
            Roullate_SoundManager.Inst.SFXAudio.mute = true;
        }
        else
        {
            IMG_SOUND.sprite = Sound_ON_Sprite;
            PlayerPrefs.SetInt("sound", 1);
            Roullate_SoundManager.Inst.SFXAudio.mute = false;
        }
    }
    ...
    public void Saved_Last_Setting()
    {
        ...
        if (PlayerPrefs.GetInt("sound").Equals(0))
        {
            ...
            PlayerPrefs.SetInt("sound", 0);
            Roullate_SoundManager.Inst.SFXAudio.mute = true;
            Roullate_SoundManager.Inst.SFX_OHERS.mute = true;
        }
        else
        {
            IMG_SOUND.sprite = Sound_ON_Sprite;
            PlayerPrefs.SetInt("sound", 1);
            Roullate_SoundManager.Inst.SFXAudio.mute = false;
            Roullate_SoundManager.Inst.SFX_OHERS.mute = false;
        }
    }
