namespace ZooRoulette_Game
{
    ...
    public class ZooRouletteSaveManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            if (!isTest)
            {
                ...
                _userBetDataClass = ZooRoulette_DataConfig.LoadUserBetData();
        ...
        public void CheckAlreadyUserBetStatus(int side, int amt, UserStatus addStatus)
        {
            ...
            ZooRoulette_DataConfig.SaveUserBetData(_userBetDataClass);
        }
