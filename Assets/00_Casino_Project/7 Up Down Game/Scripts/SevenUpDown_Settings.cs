...
public class SevenUpDown_Settings : MonoBehaviour
{
    public static SevenUpDown_Settings Inst;
    ...
    public void Music_ON_OFF()
    {
        ...
        if (PlayerPrefs.GetInt("music").Equals(1))
        {
            ...
            PlayerPrefs.SetInt("music", 0);
            SevenUpDown_SoundManager.Inst.BGAudio.mute = true;
        }
        else
        {
            IMG_MUSIC.sprite = Music_ON_Sprite;
            PlayerPrefs.SetInt("music", 1);
            SevenUpDown_SoundManager.Inst.BGAudio.mute = false;
        }
    }
    ...
    public void Sound_ON_OFF()
    {
        ...
        if (PlayerPrefs.GetInt("sound").Equals(1))
        {
            ...
            PlayerPrefs.SetInt("sound", 0);
            SevenUpDown_SoundManager.Inst.SFXAudio.mute = true;
        }
        else
        {
            IMG_SOUND.sprite = Sound_ON_Sprite;
            PlayerPrefs.SetInt("sound", 1);
            SevenUpDown_SoundManager.Inst.SFXAudio.mute = false;
        }
    }
