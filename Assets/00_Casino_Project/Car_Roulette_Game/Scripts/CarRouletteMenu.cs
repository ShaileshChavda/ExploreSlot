namespace CarRoulette_Game
{
    ...
    using DG.Tweening;
    public class CarRouletteMenu : MonoBehaviour
    {
        public static CarRouletteMenu Inst;
        ...
        public void Music_ON_OFF()
        {
            ...
            if (PlayerPrefs.GetInt("music").Equals(1))
            {
                ...
                Car_Roulette_Sound.Inst.BGAudio.mute = true;
            }
            else
            {
                IMG_MUSIC.sprite = Music_ON_Sprite;
                PlayerPrefs.SetInt("music", 1);
                Car_Roulette_Sound.Inst.BGAudio.mute = false;
            }
        }
        ...
        public void Sound_ON_OFF()
        {
            ...
            if (PlayerPrefs.GetInt("sound").Equals(1))
            {
                ...
                Car_Roulette_Sound.Inst.SFXAudio.mute = true;
            }
            else
            {
                IMG_SOUND.sprite = Sound_ON_Sprite;
                PlayerPrefs.SetInt("sound", 1);
                Car_Roulette_Sound.Inst.SFXAudio.mute = false;
            }
        }
        ...
        public void Saved_Last_Setting()
        {
            ...
            if (PlayerPrefs.GetInt("sound").Equals(0))
            {
                ...
                PlayerPrefs.SetInt("sound", 0);
                Car_Roulette_Sound.Inst.SFXAudio.mute = true;
                Car_Roulette_Sound.Inst.SFX_OHERS.mute = true;
            }
            else
            {
                IMG_SOUND.sprite = Sound_ON_Sprite;
                PlayerPrefs.SetInt("sound", 1);
                Car_Roulette_Sound.Inst.SFXAudio.mute = false;
                Car_Roulette_Sound.Inst.SFX_OHERS.mute = false;
            }
        }
