...
public class HR_Settings : MonoBehaviour
{
    public static HR_Settings Inst;
    ...
    [SerializeField] GameObject Obj_Rules_SC;
    ...
    {
        HR_SoundManager.Inst.PlaySFX(0);
        GS.Inst.iTwin_Open(Obj_Rules_SC);
    }

    public void Rules_Close()
    {
        HR_SoundManager.Inst.PlaySFX(0);
        GS.Inst.iTwin_Close(Obj_Rules_SC, 0.3f);
    }
    ...
    public void Music_ON_OFF()
    {
        ...
        if (PlayerPrefs.GetInt("music").Equals(1))
        {
            ...
            PlayerPrefs.SetInt("music", 0);
            HR_SoundManager.Inst.BGAudio.mute = true;
        }
        else
        {
            IMG_MUSIC.sprite = Music_ON_Sprite;
            PlayerPrefs.SetInt("music", 1);
            HR_SoundManager.Inst.BGAudio.mute = false;
        }
    }
    ...
    public void Sound_ON_OFF()
    {
        ...
        if (PlayerPrefs.GetInt("sound").Equals(1))
        {
            ...
            PlayerPrefs.SetInt("sound", 0);
            HR_SoundManager.Inst.SFXAudio.mute = true;
        }
        else
        {
            IMG_SOUND.sprite = Sound_ON_Sprite;
            PlayerPrefs.SetInt("sound", 1);
            HR_SoundManager.Inst.SFXAudio.mute = false;
        }
    }
